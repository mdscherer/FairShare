...
A private, dependency-free bill splitter inspired by Splitwise's core group-expense workflow. The entire app—markup, styling, calculations, and persistence—is contained in [`index.html`](index.html).
